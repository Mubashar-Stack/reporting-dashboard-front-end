...
export default function HorizontalLabelPositionBelowStepper(props) {
  ...
  React.useEffect(() => {
    if (isEdit || isView) {
      let config = {
        method: 'get',
        url: `https://reporting-dashboard-back-end.herokuapp.com/domains/${data?.id}`,
        headers: {},
      };
      axios(config)
  ...
  const handleNext = () => {
    if (activeStep === steps.length - 1) {
      if (isEdit) {
        ...
        var config = {
          method: 'put',
          url: `https://reporting-dashboard-back-end.herokuapp.com/domain/update/${data?.id}`,
          headers: {},
          data: newData,
        };
        ...
        if (files.length > 0) {
          ...
          var config = {
            method: 'post',
            url: 'https://reporting-dashboard-back-end.herokuapp.com/domain/add',
            headers: {},
            data: newData,
          };
