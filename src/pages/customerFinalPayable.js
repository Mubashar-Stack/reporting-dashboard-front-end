...
export default function User() {
  ...
  useEffect(() => {
    let config = {
      method: 'get',
      url: `https://reporting-dashboard-back-end.herokuapp.com/user-monthly-payable?domain_name=${domainSelected}&month=${
  ...
  useEffect(() => {
    let config = {
      method: 'get',
      url: `https://reporting-dashboard-back-end.herokuapp.com/users_domains_by_user_id/${window.localStorage.getItem('id')}`,
      headers: {},
    };
    axios(config)
      .then(function (response) {
